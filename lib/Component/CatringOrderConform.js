                        ...
                        post.map((data) => (
                            <Box>
                                <Box style={styles.mainBox}>
                                    ...
                                    <Text style={styles.text}>Drop Address: {data.drop}</Text>
                                    <Text style={styles.text}>Drop Time: {data.pickTime}</Text>
                                    <Text style={styles.text}>Booking Price: {data.price}</Text>
...
export default CatringConfirmOrder
