...
export default function AddPackage(props) {
    ...
    const AddPackage = () => {
        ...
        if (title !== '' && description !== '' && address !== '' && video !== '' && price12 !== '' && price24 !== '' && service !== '') {
    ...
    const uploadImgTwo = () => {
        ImagePicker.openPicker({
            ...
            try {
                reference.putFile(imageUri).then(() => { setShowModal2(true) })
            } catch (error) {
                console.log(error);
            }
        });
    ...
    async function getImageURLTwo() {
        return await storage()
            ...
            .then((uri) => {
                setImgURL2(uri)
            }).then(alert('image second upload success'))
            .catch((e) => console.log(e));
    }
    ...
    const uploadImgThird = () => {
        ImagePicker.openPicker({
            ...
            try {
                reference.putFile(imageUri).then(() => { setShowModal3(true) })
            } catch (error) {
                console.log(error);
            }
        });
    ...
    async function getImageURLThird() {
        return await storage()
            ...
            .then((uri) => {
                setImgURL3(uri)
            }).then(alert('image third upload success'))
            .catch((e) => console.log(e));
    }
                    ...
                    <Box mt="10" height="100%">
                        <Center>
                            ...
                            <Box mt='2'>
                                ...
                                >
                                    <Select.Item label="Diamond" value="Diamond" />
                                    <Select.Item label="Golden" value="Golden" />
