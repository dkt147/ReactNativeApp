                    ...
                    {udata != '' ? udata.map((data) => (
                        <Box>
                            <Box style={styles.mainBox}>
                                ...
                                <Button w='50%' mr='1' onPress={() => (Confirm(data.name, data.number, data.quantity, data.date, data.farmname, data.coustumeremail, data._id, data.pickupAddress, data.dropAddress, data.time), setValue('Accpet'))}>Accpet</Button>
                                <Button w='50%' onPress={() => (Confirm(data.name, data.number, data.quantity, data.date, data.farmname, data.coustumeremail, data._id, data.pickupAddress, data.dropAddress, data.time), setValue('Accpet'))}>Reject</Button>
                                </Box>
                            </Box>
                        </Box>
